...
<#
    ...
    12/02/2018   GRL  Added grid view output option. Convert non-PowerShell registry provider paths. Added suport for HKEY_CLASSES_ROOT
#>
...
if( $results -and $results.Count )
{
    ...
    elseif( $gridView )
    {
        $results | Out-GridView -Title $message
    }
    else
    {
